...
import { addMilestoneToProject, deleteMilestoneFromProject } from "@/server/actions/project-milestones";
    ...
    <section className="card p-5">
      ...
      {milestones.length === 0 ? (
        ...
        <table className="table-base mb-4">
          <thead><tr><th>Libellé</th><th className="text-right">Montant</th><th>Date prévue</th><th>Statut</th><th></th></tr></thead>
          <tbody>
            {milestones.map(m => (
              <tr key={m.id}>
