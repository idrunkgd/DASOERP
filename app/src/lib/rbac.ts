...
export async function requireSession() {
  // Le swap "mode démo → Jean Démo" est fait au niveau du callback session
  // de NextAuth (voir lib/auth.ts), donc getServerSession() renvoie déjà la
  // session impersonée. Rien à faire ici.
